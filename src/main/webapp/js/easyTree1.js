        ...
        TreeLoader : function(treeSelector) {
            ...
            this.buildTree = function(customerOptions) {
                ...
                $(this.easyTree).each(function () {
                    ...
                    // addable
                    if (options.addable) {
                        $(easyTree).find('.easy-tree-toolbar .operatebar').append('<div class="create"><button class="btn btn-default btn-md btn-success disabled"><span class="icon icon-plus-6"></span></button></div> ');
