...
<div class="row m-t-20 m-b-20">
	<div class="col-sm-10 col-sm-offset-1 mm-box form-horizontal filter-pan">
        <div class="row-fluid">
            <h3 class="text-success text-center">后台类目树展示</h3>
        ...
        <div class="row m-b-20 text-center">
            ...
            <div class="col-md-8 col-centered">
                <input class="holo" type="text" style="width: 100%" id="remark" name="remark" placeholder="备注">
            </div>
        </div>
...
<#include "selectAdjustPoicategory.ftl">
